...
public:
	...
	TranslateZoneObject(long double* gameTimeFrame, sf::Vector2f* xyTranslation);
	TranslateZoneObject(long double* gameTimeFrame, sf::Vector2f* xyTranslation, int translateX, int translateY);
	...
	TranslateZoneObject(sf::Vector2f start, sf::Color color, long double* framePeriod, long double* gameTimeFrame, bool* focused, sf::Vector2f* xyTranslation,
		std::vector<AbstractGameObject*>* objectList, int translateX, int translateY);
