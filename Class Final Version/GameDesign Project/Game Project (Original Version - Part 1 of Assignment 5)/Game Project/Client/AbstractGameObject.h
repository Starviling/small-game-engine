...
public:
	AbstractGameObject(long double* framePeriod, long double* gameTimeFrame, bool* focused, bool collision, sf::Vector2f* xyTranslation, std::vector<AbstractGameObject*>* objectList);
