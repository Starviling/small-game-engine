...
public:
	...
	PlayerObject(float xloc, float yloc, long double* gameTimeFrame, sf::Vector2f* xyTranslation);

	// Constructor for the player object
	PlayerObject(float xloc, float yloc, long double* framePeriod, long double* gameTimeFrame, bool* focused,
		std::vector<AbstractGameObject*>* objectList, sf::Vector2f* xyTranslation);
