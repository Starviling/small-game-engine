...
PlatformObject::PlatformObject(long double* gameTimeFrame, sf::Vector2f* xyTranslation, std::vector<int>* deleteList)
	:AbstractGameObject(NULL, gameTimeFrame, NULL, false, xyTranslation, NULL, deleteList)
{
...
PlatformObject::PlatformObject(sf::Vector2f start, sf::Color color, long double* framePeriod, long double* gameTimeFrame, bool* focused, sf::Vector2f* xyTranslation,
	...
	: PlatformObject(start, color, DEFAULT_ORIENTATION, framePeriod, gameTimeFrame, focused, xyTranslation, objectList, deleteList) {}
...
PlatformObject::PlatformObject(sf::Vector2f start, sf::Color color, float orientation, long double* framePeriod, long double* gameTimeFrame, bool* focused, sf::Vector2f* xyTranslation,
	std::vector<AbstractGameObject*>* objectList, std::vector<int>* deleteList)
	: PlatformObject(start, color, orientation, start, 0, framePeriod, gameTimeFrame, focused, xyTranslation, objectList, deleteList) {}
...
PlatformObject::PlatformObject(sf::Vector2f start, sf::Color color, float orientation, sf::Vector2f end, float speed,
	...
	: PlatformObject(start, color, orientation, end, speed, DEFAULTLENGTH, DEFAULTWIDTH, framePeriod, gameTimeFrame, focused, xyTranslation, objectList, deleteList) {}
...
PlatformObject::PlatformObject(sf::Vector2f start, sf::Color color, float orientation, sf::Vector2f end, float newSpeed,
	...
	:AbstractGameObject(framePeriod, gameTimeFrame, focused, false, xyTranslation, objectList, deleteList)
{
